...
// Loaded after scene.js; CONFIG.scene.shared and CONFIG.scene.layout are available.
//
...
var LEVELS = (function() {
  return [
    ...
    Object.assign({}, CONFIG.scene.shared, {
      timer: 60,
    ...
    Object.assign({}, CONFIG.scene.shared, {
      ...
      teachers: [
        ...
        {x:80,  y:MY-PH-walkOffset, dir:-1, minX:10, maxX:305, speed:0.60, color:PAL.profCelesteBody, name:'Prof.Celeste', sight:90},
