...
let machines, gymBall, paperBalls, students, throwCooldown, bookcase;
let shakeTime, deflateTime, dropTime;
...
function resetLevel() {
  ...
  msgText = ''; msgT = 0;
  actionPressed = false; allBoards = false; allBags = false; allMachines = false; allBall = false; allStudents = false; allBooks = false;
