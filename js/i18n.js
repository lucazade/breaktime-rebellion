...
(function() {
  ...
  var en = {
    ...
    mission3:      'Smash all vending machines, then ring the bell!',
    machineBroken: 'Machine smashed! ({0}/{1}) — Run!',
  ...
  var it = {
    ...
    mission3:      'Spacca tutti i distributori, poi suona la campanella!',
    machineBroken: 'Distributore distrutto! ({0}/{1}) — Scappa!',
